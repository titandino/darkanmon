package com.darkanmon.graphic.shader;
...
import com.darkanmon.utils.ResourceManager;
...
public abstract class Shader {
	...
	public void setUniformMatrix4(String uniform, Matrix4f value) {
		...
		matrixBuffer.flip();
		glUniformMatrix4fv(glGetUniformLocation(program, uniform), false, matrixBuffer); //TODO CHECK THIS ROFL
	}
